                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <form action="post" class="nrrds-validation" novalidate>
                            ...
                            <button class="btn btn-success w-100" type="submit" name="calcular previsão">Calcular previsão</button>
                        </form>
                    </div>
                </div>
            </div>
                                        ...
                                        <td>
                                            <div class="action-wrapper">
                                                <form action="post"
                                                 ...
                                                 <!-- Botão Deletar (sempre disponivel para adm) -->
                                                  <button class="btn btn-danger btn-sm delete-btn" type="submit" submit name="deletar">
                                                    Deletar
                                                  </button>
